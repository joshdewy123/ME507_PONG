...
\hypertarget{md__r_e_a_d_m_e_autotoc_md7}{}\doxysubsection{\texorpdfstring{Fusion 360 CAD Render}{Fusion 360 CAD Render}}\label{md__r_e_a_d_m_e_autotoc_md7}
 
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{pcb_model.png}
\doxyfigcaption{PCB CAD Model}
\end{DoxyImage}
   \hypertarget{md__r_e_a_d_m_e_autotoc_md8}{}\doxysubsection{\texorpdfstring{Assembled PCB -\/ Before Hotfixes}{Assembled PCB -\/ Before Hotfixes}}\label{md__r_e_a_d_m_e_autotoc_md8}
 
\begin{DoxyImage}
\includegraphics[width=\textwidth,height=\textheight/2,keepaspectratio=true]{pcb_before_hotfix.jpg}
\doxyfigcaption{Before Fix}
\end{DoxyImage}
   \hypertarget{md__r_e_a_d_m_e_autotoc_md9}{}\doxysubsection{\texorpdfstring{Assembled PCB -\/ After Hotfixes}{Assembled PCB -\/ After Hotfixes}}\label{md__r_e_a_d_m_e_autotoc_md9}
...
\DoxyHorRuler{0}
\hypertarget{md__r_e_a_d_m_e_autotoc_md11}{}\doxysection{\texorpdfstring{⚠️ Roadblocks and Debugging Challenges}{⚠️ Roadblocks and Debugging Challenges}}\label{md__r_e_a_d_m_e_autotoc_md11}
\hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxysubsection{\texorpdfstring{1. {\bfseries{Motor Driver Output Failures}}}{1. {\bfseries{Motor Driver Output Failures}}}}\label{md__r_e_a_d_m_e_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysubsubsection{\texorpdfstring{Fusion Schematic Before Fix}{Fusion Schematic Before Fix}}\label{md__r_e_a_d_m_e_autotoc_md13}
...
\end{DoxyImage}
   \hypertarget{md__r_e_a_d_m_e_autotoc_md14}{}\doxysubsubsection{\texorpdfstring{Fusion Schematic After Fix}{Fusion Schematic After Fix}}\label{md__r_e_a_d_m_e_autotoc_md14}
...
\DoxyHorRuler{0}
\hypertarget{md__r_e_a_d_m_e_autotoc_md16}{}\doxysubsection{\texorpdfstring{2. {\bfseries{LIDAR Inconsistent I2C Behavior}}}{2. {\bfseries{LIDAR Inconsistent I2C Behavior}}}}\label{md__r_e_a_d_m_e_autotoc_md16}
{\bfseries{Issue\+:}} TF-\/\+Luna LIDAR would intermittently drop off the I2C bus. ~\newline
 ...
 {\bfseries{Fix\+:}} Manually added 10kΩ pull-\/ups from both lines to 3.\+3V.\hypertarget{md__r_e_a_d_m_e_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{Fusion Schematic Before Fix}{Fusion Schematic Before Fix}}\label{md__r_e_a_d_m_e_autotoc_md17}
...
\end{DoxyImage}
   \hypertarget{md__r_e_a_d_m_e_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{Fusion Schematic After Fix}{Fusion Schematic After Fix}}\label{md__r_e_a_d_m_e_autotoc_md18}
...
\end{DoxyImage}
   \hypertarget{md__r_e_a_d_m_e_autotoc_md19}{}\doxysubsubsection{\texorpdfstring{Physical Pull-\/up Resistor Fix (3 Angles)}{Physical Pull-\/up Resistor Fix (3 Angles)}}\label{md__r_e_a_d_m_e_autotoc_md19}
...
\DoxyHorRuler{0}
\hypertarget{md__r_e_a_d_m_e_autotoc_md21}{}\doxysection{\texorpdfstring{🧠 Software \& Control Strategy}{🧠 Software \& Control Strategy}}\label{md__r_e_a_d_m_e_autotoc_md21}
...
\DoxyHorRuler{0}
\hypertarget{md__r_e_a_d_m_e_autotoc_md23}{}\doxysection{\texorpdfstring{📈 Future Work}{📈 Future Work}}\label{md__r_e_a_d_m_e_autotoc_md23}
...
\DoxyHorRuler{0}
\hypertarget{md__r_e_a_d_m_e_autotoc_md25}{}\doxysection{\texorpdfstring{📂 Repository Structure}{📂 Repository Structure}}\label{md__r_e_a_d_m_e_autotoc_md25}
